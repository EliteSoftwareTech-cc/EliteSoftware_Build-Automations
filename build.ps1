...
$components = @(
    ...
    "EliteSoftware-VersionBumper",`n    "EliteSoftware-CLSIDGenerator",`n    "EliteSoftware-SmartRegsvr",`n    "EliteSoftware-InnoCreator",`n    "EliteSoftware-RCManager",`n    "EliteSoftware-IconReplacer",`n    "EliteSoftware-Symlinker",`n    "EliteSoftware-DuplicateSweeper",`n    "EliteSoftware-SiteCompiler",
